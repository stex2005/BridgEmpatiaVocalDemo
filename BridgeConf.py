...
class BridgeCoordClass:
    def __init__(self):
        ...
        # per controllo step dei comandi vocali
        self.steps                      = 0
        self.max_steps                  = 100
        self.countSteps                 = self.max_steps
...
class BridgeConfClass:
    ...
    def ReadConfFile (self):
        try:
            ...
            self.serial.COM[0]         = Config.get(section[0],"COM_M1")
            self.serial.COM[1]         = Config.get(section[0],"COM_M2")
            self.serial.COM[2]         = Config.get(section[0],"COM_M3")
            self.serial.COM[3]         = Config.get(section[0],"COM_M4")
            self.serial.COM[4]         = Config.get(section[0],"COM_M5")
